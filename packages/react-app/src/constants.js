...
// Used for debugging logged in flow locally without spending ETH
export const DEBUG_TRANSACTIONS = false;
...
export const NETWORKS = {
  ...
  matic: {
    ...
    price: 1,
    gasPrice: 1000000000,
    rpcUrl: "https://polygon-mainnet.g.alchemy.com/v2/Fj7tN5zWdJpWwxybbr_42oj_--QnUssS",
