...
import { Home, Queue, ExampleUI, Hints, Subgraph } from "./views";
...
function App(props) {
  ...
  const purpose = useContractReader(readContracts, "TinderChain", "purpose");
  ...
  */
  ...
  return (
    <div className="App">
      ...
      <Switch>
        <Route exact path="/">
          <Home isLoggedIn={web3Modal?.cachedProvider} userAddr={address} />
        </Route>
